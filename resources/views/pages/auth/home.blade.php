            ...
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-lg-4 text-center">
                        <img src="{{ asset('img_home/img/model.png') }}" class="img-fluid"
                ...
                <div class="accordion" id="faqAccordion">
                    ...
                    <div class="accordion-item rounded-3 shadow-sm mb-3 border-0">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed py-3 px-4 rounded-3 fw-semibold" type="button"
                        ...
                        <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body px-4">
                                Kamu bisa mendaftar akun melalui tombol <strong>Daftar</strong> di halaman utama, lalu
                                mengisi form sesuai data diri. Setelah itu kamu akan diarahkan ke proses verifikasi email.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item rounded-3 shadow-sm mb-3 border-0">
                        ...
                        <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body px-4">
                                Setelah berhasil masuk, kamu bisa memilih posisi magang yang tersedia dan mengajukan lamaran
                                dengan mengisi data dan dokumen yang dibutuhkan.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item rounded-3 shadow-sm mb-3 border-0">
                        ...
                        <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body px-4">
                                Tidak. Setiap peserta hanya diperbolehkan mendaftar satu posisi magang dalam satu periode
                                agar seleksi berjalan optimal.
                            </div>
                        </div>
                    </div>
                </div>
