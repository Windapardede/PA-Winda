    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card card-custom">
                ...
                <form action="{{ route('penilaian.store', 'id='.$id) }}" method="POST">
                    @csrf
                                ...
                                <div id="personal-criteria-container">
                                    ...
                                    <div class="kriteria-item">
                                        <div class="form-group-custom">
                                            ...
                                            <input type="text" name="personal_komponen[]" class="form-control-custom" placeholder="Komponen Penilaian" value="{{ $item['komponen'] }}" required>
                                        </div>
                                        <div class="form-group-custom nilai-input-group">
                                            <label>Nilai</label>
                                            <input type="number" name="personal_nilai[]" class="form-control-custom" placeholder="Nilai" min="0" max="100" value="{{ $item['nilai'] }}" required>
                                        </div>
