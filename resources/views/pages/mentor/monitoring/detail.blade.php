    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1 class="section-title">Detail Projek</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></div>
                    <div class="breadcrumb-item"><a href="{{ route('monitoring.index') }}">Monitoring</a></div>
                    <div class="breadcrumb-item"><a href="{{ route('detailmonitoring.index') }}">Judul Projek</a></div>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="aksiDropdown{{ $item->id }}">
                                                ...
                                                <a class="dropdown-item terima-btn" href="#"
                                                    data-id="{{ $item->id }}" data-nama="{{ $item->deskripsi }}">
                                                    <i class="fas fa-check"></i> Diterima
                                                </a>
                                                <a class="dropdown-item tolak-btn" href="#"
                                                    data-detail-id="{{ $item->id }}"
                                                    data-detail-catatan="{{ $item->revisi }}">
            ...
            <div class="modal-content modal-content-custom">
                ...
                <div class="modal-body-custom">
                    <form id="formRevisi">
                        ...
                        <div class="mb-3">
                            <textarea class="form-control" id="catatanRevisi" name="catatan_revisi" rows="5"
                                placeholder="1. Jelaskan revisi secara jelas dan spesifik.&#10;2. Tulis revisi dalam bentuk poin-poin terpisah.&#10;3. Lakukan review ulang pastikan tidak ada kesalahan dalam penulisan"></textarea>
                        </div>
                    </form>
                </div>
