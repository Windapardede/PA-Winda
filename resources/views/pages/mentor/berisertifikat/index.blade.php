...
@push('style')
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css"
        integrity="sha512-1ycn6IcaQQmQa7TBcVRBuKjXo/w1QkguhIyyLK4yrQX0Yv5i7k/tVElnXoltgFNnMqEzlnDHkz1NW0xPEaBwvsuJVksPdodPIFnFgzomxhJlY9lGqlTgfgcwKSjy23z4lwh9+nHm0Pdu7Z35wg=="
...
@section('main')
                                ...
                                <td class="text-center align-middle">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right"
                                            ...
                                            <button class="dropdown-item beri-sertifikat-btn" data-toggle="modal"
                                                data-target="#confirmBeriSertifikatModal" data-item-id="{{ $item->id }}"
                                                data-item-nama="{{ $item->user_name }}" {{ $item->beri ? 'disabled' : '' }}>
                                                <i class="{{ $item->beri ? '' : 'bi bi-pencil' }}"></i>
                                                {{ $item->beri ? 'Sudah Diberikan' : 'Beri Sertifikat' }}
                                            </button>

                                            <div class="dropdown-divider"></div>
                                            <a href="#" class="dropdown-item" data-toggle="modal"
                                                data-target="#checkRequirementsModal">
    ...
    <div class="modal fade check-requirements-modal" id="checkRequirementsModal" tabindex="-1"
        aria-labelledby="checkRequirementsModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="confirmBeriSertifikatModal" tabindex="-1" role="dialog"
        aria-labelledby="confirmBeriSertifikatModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-custom">
                <div class="modal-body">
                    ...
                    <p class="modal-message-custom">Apakah Anda yakin ingin memberikan sertifikat <strong
                            id="namaval"></strong> ini?</p>
    ...
    <div class="modal fade" id="successAddPosisiModal" tabindex="-1" role="dialog"
        aria-labelledby="successAddPosisiModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-custom">
        ...
        $(document).ready(function() {
            ...
            $('#confirmBeriSertifikatModal form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        alert('Terjadi kesalahan saat memperbarui sertifikat: ' + xhr
                            .responseText);
                    }
                });
            });
