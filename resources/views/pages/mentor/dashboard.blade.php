            ...
            <div class="container py-4">
                <div class="row">
                        ...
                        <a href="{{ route('pesertamagangaktif.index') }}" class="card-link"> {{-- Tambahkan tag <a> dan href="#" --}}
                            <div class="card modern-card text-center">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted mb-1">Data Mentee Aktif</p>
                                    <div class="progress">
                    ...
                    <div class="col-md-3 col-sm-6 mb-4">
                        ...
                        <a href="{{ route('monitoring.index') }}" class="card-link"> {{-- Tambahkan tag <a> dan href="#" --}}
                            <div class="card modern-card text-center">
                                <div class="card-body">
                                    <div class="mb-2">
                                    ...
                                    <h3 class="mb-0">{{ $data['total_monitoring'] }}</h3>
                                    <p class="text-muted mb-1">Data Monitoring</p>
                                    <div class="progress">
                    ...
                    <div class="col-md-3 col-sm-6 mb-4">
                        ...
                        <a href="{{ route('dataalumni.index') }}" class="card-link"> {{-- Tambahkan tag <a> dan href="#" --}}
                            <div class="card modern-card text-center">
                                <div class="card-body">
                                    <div class="mb-2">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar bg-success" style="width: 70%; background-color: #198754;">
                                        </div>
                                    </div>
                                </div>
                            </div>
