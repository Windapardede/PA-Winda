                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="icon-button detail-btn-testimoni" data-toggle="modal" data-target="#detailTestimoniModal" data-nama="{{ @$item->nama->name }}" data-instansi="{{ @$item->nama->posisi->nama }}" data-posisi="{{ @$item->nama->posisi->nama }}" data-testimoni="{{ @$item->content }}" aria-label="Lihat detail testimoni {{ $item['id'] }}">
...
<div class="modal fade" id="detailTestimoniModal" tabindex="-1" role="dialog" aria-labelledby="detailTestimoniModalLabel" aria-hidden="true">
