                    ...
                    <form action="{{ route('kemampuan.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('soal') is-invalid @enderror" id="deskripsi" name="deskripsi" style="height:80px"
                                    required>{{ old('deskripsi', @$soal->deskripsi) }}</textarea>
                                @error('deskripsi')
                            ...
                            <div class="form-group">
                                <label for="tanggal_awal_seleksi">Tanggal Awal Seleksi <span
                                        class="text-danger">*</span></label>
                                <input type="date"
                                    class="form-control @error('tanggal_awal_seleksi') is-invalid @enderror"
                                    id="tanggal_awal_seleksi" name="tanggal_awal_seleksi"
                            ...
                            <div class="form-group">
                                <label for="tanggal_akhir_seleksi">Tanggal Akhir Seleksi <span
                                        class="text-danger">*</span></label>
                                <input type="date"
                                    class="form-control @error('tanggal_akhir_seleksi') is-invalid @enderror"
                                    id="tanggal_akhir_seleksi" name="tanggal_akhir_seleksi"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('soal') is-invalid @enderror" id="soal" name="soal" style="height:330px"
