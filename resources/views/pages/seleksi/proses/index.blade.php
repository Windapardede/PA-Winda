                ...
                <div class="row mb-4 align-items-center">
                    <form action="{{ route('seleksiproses.index') }}" method="GET" style="width: 100%;display: flex;">
                        <div class="col-md-2 d-flex align-items-center">
                            ...
                            <select class="form-control form-control-sm" style="width: 80px;" name="show"
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="position-relative">
                                ...
                                <input type="text" name="search" class="form-control pl-5 shadow-sm"
                                    value="{{ request('search') }}" placeholder="Search Nama Pendaftar..."
                                    style="height: 45px;">
                            </div>
                                ...
                                <tr>
                                    ...
                                    @if (Auth::user()->role === 'admin')
                                        <td class="text-center">
                                            <a href="{{ url($url . '?status=belumDiproses') }}" class="icon-button"
                                                title="Lihat Detail">
