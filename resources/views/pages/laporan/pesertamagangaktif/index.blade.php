...
@section('title', 'Peserta Magang Aktif')
...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1 class="section-title">Peserta Magang Aktif</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></div>
                <div class="breadcrumb-item">Peserta Magang Aktif</div>
            </div>
        </div>
        ...
        <div class="section-body">
            ...
            <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
                <form action="{{ route('pesertamagangaktif.index') }}" method="GET" class="mr-2 mb-2" style="width: 100%;display: flex;flex-direction: row;">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('pesertamagangaktif.export.pdf') }}" method="GET" target="_blank" id="exportForm">
