    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
                ...
                <form action="{{ route('alumnimagang.index') }}" method="GET" class="mr-2 mb-2" style="width: 100%;display: flex;flex-direction: row;">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('alumnimagang.export.pdf') }}" method="GET" target="_blank" id="exportForm">
