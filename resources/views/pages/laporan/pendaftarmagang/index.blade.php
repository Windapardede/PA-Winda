        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="row mb-4 align-items-center">
                    <form action="{{ route('pendaftarmagang.index') }}" method="GET" style="width: 100%;display: flex;">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-rounded">
                        ...
                        <tbody>
                            @forelse($pendaftarmagang as $i => $item)
                                <tr>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center">Tidak ada data pendaftar magang yang ditemukan.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('pendaftarmagang.export.pdf') }}" method="GET" target="_blank"
                        id="exportForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="sort-options">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="sort_order" id="sortAscending"
                                        value="asc" checked>
                                    <label class="form-check-label" for="sortAscending">Ascending</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="sort_order" id="sortDescending"
                                        value="desc">
