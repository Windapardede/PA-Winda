...
@section('main')
            ...
            <div class="section-body">
                ...
                @if (isset($currentMentor))
                    <div class="mentor-info">
                        Menampilkan mentee untuk Mentor:
                        <strong>{{ $currentMentor->nama ?? 'Nama Mentor Tidak Ditemukan' }}</strong>
                            ...
                            @forelse ($assignedMentees as $mentee)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="icon-button btn-hapus-mentee" data-mentee-id="{{ $mentee->id }}"
                                            data-mentee-nama="{{ $mentee->name ?? 'Mentee' }}" title="Hapus Mentee">
    ...
    {{-- Modal Tambah Mentee --}}
    <div class="modal fade" id="modalTambahMentee" tabindex="-1" role="dialog" aria-labelledby="modalTambahMenteeLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formTambahMentee"
                        action="{{ isset($currentMentor) ? route('kelolamentor.mentee.store', $currentMentor->id) : '#' }}"
                        method="POST">
                        @csrf
    ...
    <div class="modal fade" id="modalKonfirmasiHapusMentee" tabindex="-1" role="dialog"
        aria-labelledby="modalKonfirmasiHapusLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
