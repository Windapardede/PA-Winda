@extends('components.user.header1') {{-- Pastikan ini header yang benar untuk posisi aktif --}}

@section('title', 'posisi')
<link href="{{ asset('user/css/styles.css') }}" rel="stylesheet" />
{{-- Pastikan Anda juga mengimpor Bootstrap CSS dan JS jika belum di header1 --}}
{{-- Contoh: --}}
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
{{-- Tambahkan Bootstrap Icons CSS (Jika ingin menggunakan ikon Bootstrap) --}}
