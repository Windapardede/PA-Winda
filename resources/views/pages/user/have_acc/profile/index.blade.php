            ...
            <div class="card p-4 mb-4">
                ...
                <div class="card-content">
                    <div class="text-center mb-4">
                        <img src="{{ asset('file?page=' . $user->image) ?? asset('default-profile.png') }}"
                    ...
                    <div class="row gx-5 gy-3">
                        <div class="col-md-6">
                            ...
                            <p class="mb-0"><strong>Curriculum Vitae :</strong>
                                @if ($user->cv)
                                    <a href="{{ asset('file?page=' . $user->cv) }}" target="_blank"
                                        class="ms-1">{{ $user->cv }} <i class="bi bi-box-arrow-up-right"></i></a>
                                @else
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="mb-0"><strong>Surat Rekomendasi :</strong>
                                @if ($user->surat)
                                    <a href="{{ asset('file?page=' . $user->surat) }}" target="_blank"
                                        class="ms-1">{{ $user->surat }} <i class="bi bi-box-arrow-up-right"></i></a>
                                @else
                                    <span class="ms-1">-</span>
                                @endif
                            </p>
