    ...
    <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
            ...
            <div class="sidebar-brand sidebar-brand-sm">
                <a href="index.html">
                    <img src="{{asset('img/logo_white.png')}}" alt="Smart Internaaship" style="max-width: 80%; height: auto;"> <!-- Logo untuk ukuran kecil -->
                </a>
            </div>

            <ul class="sidebar-menu">
                <li class="nav-item active">
                    <a href="{{url('home')}}" class="nav-link" style="color: white !important;">
                ...
                <li class="nav-item">
                    <a href="{{ route('dataalumni.index') }}" class="nav-link" style="color: white !important;">
