...
class ProfileMentorController extends Controller
{
    ...
    public function index() // Mengganti nama method dari 'showProfile' ke 'index'
    {
        ...
        return view('pages.mentor.profile.index', compact('user'));
    }
    ...
    public function update(Request $request) // Mengganti nama method dari 'updateProfile' ke 'update'
    {
        ...
        $update['nama'] = $request->input('name');
        $update['posisi_mentor'] = $request->input('position');
        $update['email'] = $request->input('email');

        Mentor::where('id', $user->mentor_id)->update($update);
    ...
    public function showChangePasswordForm()
    {
        ...
        return view('pages.mentor.profile.sandi.index');
    }
